...
compounds[14] = new Compound("C4H8O");
compounds[15] = new Compound("C4H10");
compounds[16] = new Compound("C4H10O");
compounds[17] = new Compound("CO2");
compounds[18] = new Compound("H2CO3");
compounds[19] = new Compound("C6H10O5");
compounds[20] = new Compound("C2H3Cl");
compounds[21] = new Compound("C6H12");
compounds[22] = new Compound("C4H10O");
compounds[23] = new Compound("C2H6");
compounds[24] = new Compound("CH3CH2OH");
compounds[25] = new Compound("C2H4");
compounds[26] = new Compound("C4H8O2");
compounds[27] = new Compound("C2H7N");
compounds[28] = new Compound("C8H10");
compounds[29] = new Compound("C2H4");
compounds[30] = new Compound("HOCH2CH2OH");
compounds[31] = new Compound("HCHO");
compounds[32] = new Compound("C6H12O6");
compounds[33] = new Compound("C3H8O3");
compounds[34] = new Compound("C3H8O3");
compounds[35] = new Compound("C7H16");
compounds[36] = new Compound("C6H14");
compounds[37] = new Compound("C6H14N2O2");
compounds[38] = new Compound("C4H2O3");
compounds[39] = new Compound("CH4");
compounds[40] = new Compound("CH3OH");
compounds[41] = new Compound("C3H6O2");
compounds[42] = new Compound("C10H8");
compounds[43] = new Compound("C8H18");
compounds[44] = new Compound("C5H12");
compounds[45] = new Compound("CH3CONHC6H4OC2H5");
compounds[46] = new Compound("C3H8");
compounds[47] = new Compound("CH3CH2COOH");
compounds[48] = new Compound("C7H6O3");
compounds[49] = new Compound("C8H8");
compounds[50] = new Compound("C12H22O11");
compounds[51] = new Compound("C6H5CH3");
